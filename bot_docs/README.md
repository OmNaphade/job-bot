...
- **[SOURCES.md](SOURCES.md)** — how to turn on each job source (Telegram, LinkedIn/Naukri via email, RSS/JSON feeds, direct-from-company-site via Greenhouse/Lever/Ashby), which sources were evaluated and rejected (and why), and the full environment variable reference.
